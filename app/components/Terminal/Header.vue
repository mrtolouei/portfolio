<template>
  <div class="flex items-center justify-between px-5 py-2 text-sm border-b border-gray-700">
    <div class="text-gray-100 tracking-widest uppercase">
      <NuxtLink to="/">MrTolouei.ir</NuxtLink>
    </div>
    <div class="flex items-center justify-end space-x-5">
      <div class="text-gray-400 font-console tracking-wide text-center">
        {{ formattedDate }}
      </div>
      <div class="flex items-center gap-3">
        ...
        >
          <svg v-if="!isFullscreen" class="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function updateTime() {
  ...
  formattedDate.value = `${month} ${day}${suffix}, ${year}  ${time}`
}
onMounted(() => {
  updateTime()
